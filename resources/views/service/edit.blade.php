    ...
    <div class="col-lg-12 col-md-12 mb-4">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-12"><h5 class="card-title mb-0">Update Service</h5></div>
                </div>                
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('service.update', $service->id) }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" name="fee" step="any" placeholder="0.00" value="{{ $service->fee }}">
                            @error('fee')
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="description" step="any" placeholder="Description" value="{{ $service->description }}">
                        </div>
                    </div>
