    ...
    <div class="col-lg-12 col-md-12 mb-4">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-12"><h5 class="card-title mb-0">Update Medicine</h5></div>
                </div>                
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('medicine.update', $medicine->id) }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Medicine Name" value="{{ $medicine->name }}">
                            @error('name')
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="molecule" placeholder="Molecules" value="{{ $medicine->molecule }}">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Description</label>
                            <input type="text" class="form-control" name="description" placeholder="Description" value="{{ $medicine->description }}">
                        </div>
                    </div>
