    ...
    <div class="col-lg-12 col-md-12 mb-4">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-12"><h5 class="card-title mb-0">Create Lab Subcategory</h5></div>
                </div>                
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('labsubcategory.save') }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Subcategory Name" value="{{ old('name') }}">
                            @error('name')
